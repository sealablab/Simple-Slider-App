...
This wraps cocotb_test.simulator.run() and filters stdout/stderr in real-time
using a context manager.

Usage:
    python run_with_filter.py                  # Run P1 tests with filtered output
    COCOTB_VERBOSITY=NORMAL python run_with_filter.py
    GHDL_FILTER=none python run_with_filter.py  # Disable filtering
"""
